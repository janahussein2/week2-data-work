...
# ==================================================
# Add time parts: year, month, day-of-week, hour
# ==================================================
...
# ==================================================
# Outlier helpers: IQR bounds & Winsorization
# ==================================================
...
def add_outlier_flag(df: pd.DataFrame, col: str, k: float = 1.5) -> pd.DataFrame:
    ...
    return df.assign(**{flag_col: (df[col] < lo) | (df[col] > hi)})
